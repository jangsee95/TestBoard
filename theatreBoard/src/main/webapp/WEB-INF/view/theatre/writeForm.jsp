...
<h2>공연 게시글 작성</h2>
<form action="${pageContext.request.contextPath}/theatre?act=write"
	...
	<textarea rows="30" cols="30" id="content" name="content"></textarea><br>
	<label for="gerne">장르</label>
	<input type="text" id="genre" name="genre"><br>
	<label for="playTime">공연시간(분)</label>
	<input type="number" id="playTime" name="playTime"><br>
	<label for="poster_url">포스터URL</label>
	<input type="text" id="poster_url" name="poster_url"><br>
	<label for="performanceDateTime">공연날짜</label>
	<input type="datetime-local" id="performanceDateTime" name="performanceDateTime"><br>
